...
public sealed class TerminalProfile
{
    ...
    public string ApiBaseUrl { get; set; } = GetEnv("NEXUM_DESKTOP_API_BASE", "http://192.168.1.72:5010");
    ...
    public string ServerAddress { get; set; } = GetEnv("NEXUM_DESKTOP_SERVER_ADDRESS", "192.168.1.72");
