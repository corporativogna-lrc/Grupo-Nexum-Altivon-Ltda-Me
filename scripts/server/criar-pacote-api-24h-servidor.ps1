...
Copy-Item (Join-Path $ScriptDirectory "api.env.example.ps1") $ScriptPackageDirectory -Force
Copy-Item (Join-Path $ScriptDirectory "install-nexum-api-24h-from-package.ps1") $ScriptPackageDirectory -Force
Copy-Item (Join-Path $ScriptDirectory "start-nexum-api-24h.ps1") $ScriptPackageDirectory -Force
Copy-Item (Join-Path $ScriptDirectory "verificar-api-24h.ps1") $ScriptPackageDirectory -Force
Copy-Item (Join-Path $ScriptDirectory "INSTALAR-API-24H-PACOTE-COMO-ADMIN.cmd") $TargetDirectory -Force
...
Write-Host (Join-Path $TargetDirectory "INSTALAR-API-24H-PACOTE-COMO-ADMIN.cmd")
