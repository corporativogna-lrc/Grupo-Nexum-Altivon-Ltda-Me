...
- API local fixada para autoarranque pelo usuário do Windows em `http://localhost:5012`.
...
- Próxima prioridade travada: manter publicação pública do hostname `api.nexumaltivon.com.br`, validar túnel/DNS público e avançar integrações de dropshipping, logística, gateways, e-commerce/marketplaces e financeiro.
...
- Se `https://api.nexumaltivon.com.br/health` falhar enquanto `http://localhost:5012/health` estiver saudável, o problema é DNS/túnel público, não a API local.
